...
def func_1(this, _global):
	this.fscommand("callback", "update_menu_ume_normal")
	this.fscommand("callback", "update_menu_ume_sbopen")
	this.fscommand("callback", "update_menu_ume_sb4")
	this.stop()
...
def func_3(this, _global):
	this.fscommand("callback", "update_menu_ume_normal")
	this.fscommand("callback", "update_menu_ume_sbopen_l")
	this.fscommand("callback", "update_menu_ume_sb4")
	
def func_4(this, _global):
	this.fscommand("callback", "update_menu_left")
	this.fscommand("callback", "update_menu_ume_normal_b")
	this.fscommand("callback", "update_menu_ume_sbopen_l_b")
	this.stop()
...
def func_5(this, _global):	
	...
	this.fscommand("callback", "update_menu_ume_normal_b")
	this.fscommand("callback", "update_menu_ume_sbopen_l")
	this.fscommand("callback", "update_menu_ume_sb3")
	this.stop()

def func_6(this, _global):
	this.fscommand("callback", "update_menu_ume_normal_b")
	this.fscommand("callback", "update_menu_ume_sbopen_r")
	this.fscommand("callback", "update_menu_ume_sb3")
	
def func_7(this, _global):	
	this.fscommand("callback", "update_menu_right")
	this.fscommand("callback", "update_menu_ume_normal")
	this.fscommand("callback", "update_menu_ume_sbopen_r_b")
	this.stop()
